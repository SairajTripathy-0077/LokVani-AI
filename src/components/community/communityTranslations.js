 ...
 * Bilingual string dictionary for the Community Market Linkage module.
 *
 * USAGE:
 ...
 *   Hindi strings use simple, conversational language appropriate
 *   for rural farmers with basic literacy (Class 5–8 level).
 *
 * Commit: feat(community/i18n): add bilingual translation dictionary
 */

const TRANSLATIONS = {

  /* ── Page Header ─────────────────────────────────────────────────────── */
  pageEyebrow:       { hi: 'लाइव डेटा · लोगों द्वारा · सत्यापित',       en: 'Real-Time · Crowdsourced · Verified' },
  pageTitle:         { hi: 'सामुदायिक मंडी जानकारी',                     en: 'Community Mandi Intelligence' },
  pageSubtitle:      { hi: 'अपने आस-पास की मंडी के भाव, मौसम की जानकारी और खरीदारों से सीधा जुड़ाव — हर किसान के लिए।', en: 'Crowdsourced commodity prices, localized weather alerts, and verified buyer connections — reducing information asymmetry for every farmer.' },
  reportBtn:         { hi: '📢 भाव रिपोर्ट करें',                         en: 'Report Local Rate' },

  /* ── Stats Row ───────────────────────────────────────────────────────── */
  statTotalLabel:    { hi: 'कुल रिपोर्ट',                                en: 'Total Reports' },
  statTotalSub:      { hi: 'लाइव सामुदायिक रिकॉर्ड',                    en: 'Live community records' },
  statTopLabel:      { hi: 'सबसे ज़्यादा रिपोर्ट',                       en: 'Most Reported' },
  statTopSub:        { hi: 'मात्रा के अनुसार फसल',                        en: 'Commodity by volume' },
  statAvgLabel:      { hi: 'औसत बाज़ार भाव',                              en: 'Avg Market Price' },
  statAvgSub:        { hi: 'सभी फसलों का औसत',                            en: 'Across all commodities' },
  statBuyersLabel:   { hi: 'सत्यापित खरीदार',                             en: 'Verified Buyers' },
  statBuyersSub:     { hi: 'आपके क्षेत्र में',                             en: 'In your region' },

  /* ── Price Intelligence Section ──────────────────────────────────────── */
  pricesSectionTitle:{ hi: 'लाइव मंडी भाव',                               en: 'Live Mandi Commodity Prices' },
  refreshBtn:        { hi: 'ताज़ा करें',                                   en: 'Refresh' },
  searchPlaceholder: { hi: 'फसल या मंडी का नाम खोजें…',                   en: 'Search by crop or mandi name…' },
  searchAriaLabel:   { hi: 'फसल या स्थान से खोजें',                        en: 'Search commodities by name or location' },
  loadingText:       { hi: 'मंडी भाव लोड हो रहे हैं…',                    en: 'Loading mandi rates…' },
  emptyTitle:        { hi: 'कोई परिणाम नहीं मिला',                         en: 'No results found' },
  emptySubFilter:    { hi: 'दूसरी फसल या श्रेणी चुनें।',                   en: 'Try a different search term or category filter.' },
  emptySubDefault:   { hi: 'अभी कोई रिपोर्ट नहीं है। पहले आप भाव दर्ज करें!', en: 'No reports yet. Be the first to submit a local rate!' },
  ...
  mspWarning:        { hi: '⚠️ सरकारी MSP से कम भाव — बेचने से पहले जांचें', en: 'Price below Government MSP — verify before selling' },
  ...
  /* ── Buyers Section ──────────────────────────────────────────────────── */
  buyersSectionTitle:{ hi: 'सत्यापित खरीदार नेटवर्क',                      en: 'Verified Buyer Network' },
  buyersSectionSub:  { hi: 'आपके क्षेत्र के संस्थागत खरीदार, FPO साझेदार और APMC पंजीकृत व्यापारी। किराना नोड ऑपरेटर से संपर्क करें।', en: 'Institutional buyers, FPO partners, and APMC-registered traders in your region. Contact via Kirana Node operator.' },
  accepts:           { hi: 'खरीदता है',                                      en: 'Accepts' },
  offering:          { hi: 'भाव',                                            en: 'Offering' },
  contactForPrice:   { hi: 'भाव के लिए संपर्क करें',                         en: 'Contact for price' },

  /* ── Comparison Table ────────────────────────────────────────────────── */
  compareSectionTitle:{ hi: 'मंडी भाव तुलना',                               en: 'Price Comparison Across Mandis' },
  colCommodity:      { hi: 'फसल',                                            en: 'Commodity' },
  colMin:            { hi: 'न्यूनतम (₹/kg)',                                en: 'Min (₹/kg)' },
  colAvg:            { hi: 'औसत (₹/kg)',                                    en: 'Avg (₹/kg)' },
  colMax:            { hi: 'अधिकतम (₹/kg)',                                 en: 'Max (₹/kg)' },
  colReports:        { hi: 'रिपोर्ट',                                        en: 'Reports' },

  /* ── Intel Feed ──────────────────────────────────────────────────────── */
  feedSectionTitle:  { hi: 'लाइव खबरें और सूचनाएं',                         en: 'Real-Time Community Intel Feed' },
  feedSectionSub:    { hi: 'आपके क्षेत्र से भाव की खबरें, मांग की जानकारी और बाज़ार की हकीकत — सही लगे तो "सही" दबाएं, गलत लगे तो "रिपोर्ट" करें।', en: 'Crowdsourced price alerts, demand signals, and market realities from your region — confirm intel to surface quality, flag to report inaccuracies.' },
  ...
  /* ── Trust System ────────────────────────────────────────────────────── */
  trustSectionTitle: { hi: 'विश्वास और भरोसे की जांच',                       en: 'Trust & Credibility System' },
  trustSectionSub:   { hi: 'खरीदारों और ट्रांसपोर्टरों की पहचान जांचें, दूसरे किसानों की राय पढ़ें, और शिकायत दर्ज करें।', en: 'Peer-reviewed credibility scores for buyers and transporters. Submit grievances through the Trust Node for dispute resolution.' },
  trusted:           { hi: '✅ भरोसेमंद',                                    en: 'Trusted' },
  caution:           { hi: '⚠️ सावधान रहें',                                en: 'Caution' },
  ...
  grievanceIssueLabel:{ hi: 'समस्या का प्रकार',                              en: 'Issue Type' },
  grievanceDescLabel:{ hi: 'समस्या का विवरण',                                en: 'Description' },
  grievanceDescPlaceholder:{ hi: 'समस्या स्पष्ट रूप से लिखें (कम से कम 20 अक्षर)…', en: 'Describe the issue clearly (min. 20 characters)…' },
  grievanceSubmitBtn:{ hi: 'शिकायत भेजें',                                   en: 'Submit Grievance' },
  grievanceSuccessTitle:{ hi: 'शिकायत दर्ज हो गई!',                          en: 'Grievance Submitted' },
  grievanceSuccessMsg:{ hi: 'आपकी शिकायत ट्रस्ट नोड मॉडरेटर को भेज दी गई है। 48 घंटों में जवाब मिलेगा।', en: 'Your complaint has been logged and will be reviewed by the Trust Node moderator within 48 hours.' },
  grievanceTypes:    {
  ...
  /* ── FPO Pooling ─────────────────────────────────────────────────────── */
  fpoSectionTitle:   { hi: 'FPO एकत्रीकरण — साथ बेचें, ज़्यादा पाएं',       en: 'FPO Aggregation & Harvest Pooling' },
  fpoSectionSub:     { hi: 'दूसरे किसानों के साथ अपनी फसल मिलाएं, बड़े खरीदारों तक पहुंचें और बेहतर दाम पाएं।', en: 'Pool your harvest with other farmers to meet institutional buyer demand, negotiate better prices, and reduce post-harvest losses.' },
  ...
  /* ── Logistics & Storage ─────────────────────────────────────────────── */
  logisticsSectionTitle:{ hi: 'परिवहन और भंडारण',                              en: 'Logistics & Storage Sharing' },
  logisticsSectionSub:  { hi: 'ट्रक में जगह साझा करें, कोल्ड स्टोरेज बुक करें और अपनी फसल को नुकसान से बचाएं।', en: 'Share transport space, book cold/dry storage, and coordinate deliveries to reduce post-harvest losses.' },
  ...
  /* ── Submit Report Modal ─────────────────────────────────────────────── */
  modalTitle:        { hi: 'मंडी भाव रिपोर्ट करें',                            en: 'Submit Mandi Price Report' },
  modalSubtitle:     { hi: 'अपने आस-पास के मंडी भाव दर्ज करें ताकि दूसरे किसानों को मदद मिले। * वाले खाने ज़रूरी हैं।', en: 'Report local mandi rates to help fellow farmers. Fields marked * are required.' },
  cropNameLabel:     { hi: 'फसल / माल का नाम *',                               en: 'Crop / Commodity Name *' },
  cropNamePlaceholder:{ hi: 'जैसे: टमाटर, प्याज, गेहूं',                       en: 'e.g. Tamatar, Pyaaz, Gehun' },
  categoryLabel:     { hi: 'श्रेणी',                                            en: 'Category' },
  categoryDefault:   { hi: 'श्रेणी चुनें',                                      en: 'Select a category' },
  priceLabel:        { hi: 'भाव (₹) *',                                         en: 'Price (₹) *' },
  unitLabel:         { hi: 'इकाई',                                               en: 'Unit' },
  gradeLabel:        { hi: 'गुणवत्ता श्रेणी',                                   en: 'Quality Grade' },
  gradeA:            { hi: 'ग्रेड A — प्रीमियम / निर्यात गुणवत्ता',             en: 'Grade A — Premium / Export quality' },
  gradeB:            { hi: 'ग्रेड B — सामान्य बाज़ार गुणवत्ता',                en: 'Grade B — Standard market quality' },
  gradeC:            { hi: 'ग्रेड C — सामान्य से कम / स्थानीय उपयोग',          en: 'Grade C — Below standard / local use' },
  mandiLabel:        { hi: 'मंडी / स्थान *',                                    en: 'Mandi / Location *' },
  mandiPlaceholder:  { hi: 'जैसे: आज़मगढ़ मंडी, वाराणसी APMC',                  en: 'e.g. Azamgarh Mandi, Varanasi APMC' },
  reporterLabel:     { hi: 'आपका नाम (वैकल्पिक)',                                en: 'Your Name (optional)' },
  reporterPlaceholder:{ hi: 'जैसे: रमेश कुमार (किसान)',                         en: 'e.g. Ramesh Kumar (Farmer)' },
  saveReportBtn:     { hi: '💾 रिपोर्ट सहेजें',                                 en: 'Save Report' },
  savingBtn:         { hi: 'सहेजा जा रहा है…',                                  en: 'Saving…' },
  toastSuccess:      { hi: 'भाव रिपोर्ट सफलतापूर्वक जमा हो गई! ✅',             en: 'Price report submitted successfully!' },
  toastError:        { hi: 'रिपोर्ट जमा नहीं हो सकी। फिर से कोशिश करें।',      en: 'Failed to submit report. Please try again.' },
  ...
  /* ── Weather ─────────────────────────────────────────────────────────── */
  weatherTitle:      { hi: 'लाइव मौसम जानकारी (Open-Meteo API)',               en: 'Live Regional Weather (Open-Meteo API)' },
  weatherDefault:    { hi: 'मौसम साफ है। तापमान 31°C। फसल की सिंचाई और कटाई के लिए उपयुक्त।', en: 'Weather is clear. Temperature is 31°C. Suitable for crop irrigation and harvesting.' },
